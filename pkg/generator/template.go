...
{{- /*gotype: github.com/EGT-Ukraine/dataloaden/pkg/generator.templateData*/ -}}
...
func (l *{{.LoaderName}}) Prime(key {{.KeyType}}, value {{.ValType}}) bool {
	l.mu.Lock()
	var found bool
...
func (l *{{.LoaderName}}) Clear(key {{.KeyType}}) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}
